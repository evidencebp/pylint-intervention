...
5. Dowloand from the [tools](https://github.com/evidencebp/pylint-intervention/tree/main/tools) file and copy them into the project directory.
...
8. Please go over the alerts by the order (to avoid bias) and interven in the files to fix the alerts. You can fix as many alerts as you want.
