  ...
  case when low_ccp_group <= 0.5 then
    ...
    case when N1_diff <= -13.5 then
      ...
      case when SLOC_before <= 674.5 then
         return 0.022727272727272728 # (0.022727272727272728 out of 1.0)
      else  # if SLOC_before > 674.5
