  ...
  case when high_ccp_group <= 0.5 then
    ...
    case when Comments_diff <= 10.5 then
      case when SLOC_diff <= -245.5 then
         ...
         return 0.7704918032786885 # (0.7704918032786885 out of 1.0)
