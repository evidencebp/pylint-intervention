  ...
  case when N2_diff <= -0.5 then
    ...
    case when Comments_after <= 37.5 then
      ...
      case when McCabe_sum_diff <= 0.5 then
         return 0.023255813953488372 # (0.023255813953488372 out of 1.0)
