...
def compute_commits_code_metrics(commits_df
    ...
    for _, i in commits_df.iterrows():
        ...
        path = path_format.format(project_name=project_name
                                  , commit=commit
                                  , file_name=file_name)
...
def run_compute_commits_code_metrics():
    ...
    before_path_format = VERSIONS_DIR + "/{project_name}/{commit}/before/{file_name}"
    ...
    after_path_format = VERSIONS_DIR + "/{project_name}/{commit}/after/{file_name}"
